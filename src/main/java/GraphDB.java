...
//        possibleEdges.add(e2);
    ...
    /**
     * Implemented version of A* search, modified Dijkstra’s with heuristic added
     */
     ...
     * Because the standard k-d tree data structure assumes a flat, 2-dimensional grid of points (Euclidean geometry),
     * We will need to apply a few modifications so that it works with our spherical model of the Earth.
     * Projecting each coordinate pair to a 2-D grid centered on Berkeley
     * Then computing the nearest neighbors using the k-d tree in this (x, y)(x,y) space.
     */

...
public class TestGraphBuilding {
    ...
    private static final String OSM_DB_PATH_SMALL = "berkeley-2018-small.osm.xml";
...
//    private static final String OSM_DB_PATH_SMALL = "../library-su18/bearmaps/berkeley-2018-small.osm.xml";
    ...
    public void testClosest() {
        double lon = -122.2892;
        double lat = 37.8885;
        assertEquals("If your actual value is 1790732915, make sure you are using the correct "
                + "distance metrics.", 53042711L, graph.closest(lon, lat));
    }
